...
insert into patient values (5, 'catarina', 'aveiro');
	insert into patient values (6, 'joaquim', 'berlengas');
...
insert into sensor values (77,'philips', 'mm Hg');
	...
	insert into sensor values (333,'philips', 'feet');
insert into sensor values (555,'nokia', 'anos-luz');
insert into sensor values (777,'philips', 'mm Hg');
...
insert into pan values ('pan5', 999);
	insert into pan values ('pan10', 999);
			insert into pan values ('pan50', 999);

insert into period values ('2009-01-01', '2010-01-01');
	insert into period values ('2010-01-02', '2010-09-01');
			insert into period values ('2010-01-02', '2010-05-01');
			insert into period values ('2010-09-02', '2010-12-31');
				insert into period values ('2010-09-02', '2999-12-31');

insert into period values ('2012-01-01', '2015-03-30');
	insert into period values ('2012-01-01', '2015-01-30');
...
insert into period values ('2011-01-02', '2999-12-31');
...
insert into wears values ('2015-03-30', '2999-12-31', 2, 'pan2');
...
update wears set wears_end = '2015-05-30' where wears_patient = 2 and wears_pan = 'pan2';
insert into wears values ('2015-05-31', '2999-05-31', 4, 'pan2');

/*ooooooooooooooooo*/

insert into wears values ('2009-01-01', '2010-01-01', 5, 'pan50');
insert into connects values ('2009-01-01', '2010-01-01', 55, 'nokia', 'pan50');
insert into connects values ('2009-01-01', '2010-01-01', 66, 'philips', 'pan50');
insert into connects values ('2009-01-01', '2010-01-01', 77, 'philips', 'pan50');
insert into connects values ('2009-01-01', '2010-01-01', 88, 'LG', 'pan50');

insert into wears values ('2010-01-02',  '2010-09-01', 3, 'pan50');
insert into connects values ('2010-01-02',  '2010-09-01', 55, 'nokia', 'pan50');
insert into connects values ('2010-01-02',  '2010-09-01', 66, 'philips', 'pan50');
insert into connects values ('2010-01-02', '2010-05-01', 77, 'philips', 'pan50');


insert into wears values ('2011-01-02',  '2999-12-31', 6, 'pan50');
insert into connects values ('2011-01-02',  '2999-12-31', 55, 'nokia', 'pan50');
insert into connects values ('2011-01-02',  '2999-12-31', 66, 'philips', 'pan50');
insert into connects values ('2011-01-02', '2999-12-31', 77, 'philips', 'pan50');


insert into wears values ('2010-09-02',  '2999-12-31', 5, 'pan10');
insert into connects values ('2010-09-02', '2999-12-31', 333, 'philips', 'pan10');
insert into connects values ('2010-09-02', '2999-12-31', 555, 'nokia', 'pan10');
insert into connects values ('2010-09-02', '2999-12-31', 777, 'philips', 'pan10');
insert into connects values ('2010-09-02', '2999-12-31', 88, 'LG', 'pan10');
...
insert into connects values ('2012-01-01', '2999-12-31', 66, 'philips', 'pan3');
insert into connects values ('2012-01-01', '2999-12-31', 77, 'philips', 'pan3');
update connects set connects_end = '2015-01-30' where connects_snum = 77 and connects_manuf = 'philips'; 
...
update connects set connects_end = '2015-03-30' where connects_snum = 66 and connects_manuf = 'philips'; 
