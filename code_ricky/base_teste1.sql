...
insert into period values ('2012-01-01', '2015-03-30');
	insert into period values ('2012-01-01', '2015-04-30');

insert into period values ('2015-03-30', '2015-04-30');
	insert into period values ('2015-04-30', '2999-12-31');
...
update wears set wears_end = '2015-03-30' where wears_patient = 4 and wears_pan = 'pan2';
	update wears set wears_end = '2015-04-30' where wears_patient = 1 and wears_pan = 'pan5';
	insert into wears values ('2015-03-30', '2015-04-30', 4, 'pan3');
insert into wears values ('2015-04-30', '2999-12-31', 4, 'pan5');
...
insert into connects values ('2015-11-17', '2999-12-31', 55, 'nokia', 'pan4');
