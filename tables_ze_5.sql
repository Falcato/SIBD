...
begin
	...
	if new.connects_pan in (select connects_pan from connects where new.connects_pan = connects_pan)
	 ...
	 where new.connects_pan = connects_pan)
	 and new.connects_manuf = some(select connects_manuf from connects) 
	 and new.connects_snum = some(select connects_snum from connects) then
...
insert into period values ('2012-01-01', CURDATE());
...
insert into lives values ('2012-01-01', CURDATE(),1,55555); /*ricky vive agora no meio das vacas */
insert into lives values ('2012-01-01', CURDATE(),2,22222); /*ze vive agora no guetto */
insert into lives values ('2012-01-01', CURDATE(),3,11111);	/*tomas vive agora no meio das  */
insert into lives values ('2012-01-01', CURDATE(),4,11111);	/*nabais vive agora no meio das telhas */
...
insert into device values (55,'philips', 'blood pressure');
...
insert into wears values ('2012-01-01',  CURDATE(), 3, 'pan1');
insert into wears values ('2012-01-01', CURDATE(), 2, 'pan3');
insert into wears values ('2012-01-01', CURDATE(), 4, 'pan2');


insert into connects values ('2012-01-01', CURDATE(), 55, 'philips', 'pan2');
insert into connects values ('2012-01-01', CURDATE(), 66, 'philips', 'pan1');
insert into connects values ('2012-01-01', CURDATE(), 77, 'philips', 'pan3'); 
insert into connects values ('2012-01-01', CURDATE(), 44, 'philips', 'pan3');
insert into connects values ('2012-01-01', CURDATE(), 33, 'philips', 'pan3');
...
and date(reading_datetime) > 34now(), INTERVAL 6 MONTH);
/*and connects_pan=pan_domain*/

/* Query b):																*/
select distinct connects_manuf, connects_snum, municipality_name
from connects, device, municipality, pan, wears, patient, period, lives
where connects_end = CURDATE()
and wears_end = CURDATE()
and lives_end = CURDATE()
and connects_manuf = 'philips'
