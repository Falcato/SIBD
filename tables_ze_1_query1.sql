...
insert into period values ('2', '2015-11-12');
...
/* Query b):																*/
select connects_manuf, municipality_name
from connects, device, municipality, pan, wears, patient, period
where connects_end = CURDATE()
and wears_end = CURDATE()
and liives_end=CURDATE()
and connects_manuf = 'philips'
and lives_muni=municipality_name
